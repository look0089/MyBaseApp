...
public class GlobalExceptionHandler implements UncaughtExceptionHandler {
    ...
    private static GlobalExceptionHandler mHandler;
    ...
    public void register(Context context) {
        ...
        ACTION = AppConfig.GLOBAL_EXCEPTION_ACTION;

        logPath = AppConfig.GLOBAL_EXCEPTION_SDCARD_DIR;
    }
    ...
    public static GlobalExceptionHandler getInstance() {
        ...
        if (mHandler == null) {
            mHandler = new GlobalExceptionHandler();
        }
        return mHandler;
    }
    ...
    private void systemExit() {
        ...
        intent.setAction(GlobalExceptionHandler.ACTION);
    ...
    private boolean handleException(Throwable ex) {
        ...
        if (AppConfig.GLOBAL_EXCEPTION_ENABLE)
