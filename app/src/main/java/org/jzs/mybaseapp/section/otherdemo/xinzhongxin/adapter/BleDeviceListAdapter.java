package org.jzs.mybaseapp.section.otherdemo.xinzhongxin.adapter;
...
public class BleDeviceListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup arg2) {
        ...
        viewholder.devicerecord_name.setText("广播包中的名称:" + Utils.ParseScanRecord(scanRecords.get(position)));
        return view;
    }
