...
/**
 * Created by Jzs on 2017/9/25 0025.
 */
...
public class CustomCurveChart extends View {
    ...
    public void init() {
        ...
        paintAxes.setColor(ContextCompat.getColor(getContext(), R.color.theme));
        ...
        paintCoordinate.setColor(ContextCompat.getColor(getContext(), R.color.theme));
        ...
        paintTable.setColor(ContextCompat.getColor(getContext(), R.color.deep_blue));
        ...
        paintValue.setColor(ContextCompat.getColor(getContext(), R.color.black));
